...
namespace System_Tester
{
    class CatchMemoryData : Device
    {
        ...
        CacheType CacheType;
        static string prefix = "CMEMORY_";
        static new string classWMI = "";
        public CatchMemoryData(ManagementObject instance) : base(instance, prefix)
        {/*
        ...
        {
            List<DeviceForView> result = base.GetInfo("CMEMORY");
